...
## lookup:location <!-- no list to specify lookup table file -->
- Kalyan
- Pune
- Mumbai
- Ambernath
...
## lookup:additonal_location  <!-- no list to specify lookup table file -->
data/cities.txt

## lookup:cuisine  <!-- no list to specify lookup table file -->
data/cuisine.txt
